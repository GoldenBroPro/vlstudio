...
$(function () {
  ...
  var clickNav = document.querySelectorAll('.nav-list__item .anchor');
  clickNav.forEach(function (el) {
  ...
  $('.animate-container_i1 .animate').parallax({
    xparallax: false,
    yparallax: '250px'
  });
  $('.animate-container_i2 .animate').parallax({
    xparallax: false,
    yparallax: '100px'
  });
  $('.animate-container_i3 .animate').parallax({
    xparallax: '50px',
    yparallax: false
  });
  $('.animate-container_i4 .animate').parallax({
    xparallax: '100px',
    yparallax: '100px'
  });
  $('.animate-container_i5 .animate').parallax({
    xparallax: '100px',
    yparallax: '100px'
  });
  $('.animate-container_i7 .animate').parallax({
    xparallax: false,
    yparallax: '100px'
  });
  $('.animate-container_i8 .animate').parallax({
    xparallax: '100px',
    yparallax: '100px'
  });
  $('.animate-container_i9 .animate').parallax({
    xparallax: false,
    yparallax: '250px'
  });
  $('.animate-container_i10 .animate').parallax({
    xparallax: '150px',
    yparallax: false
  });
  $('.animate-container_i11 .animate').parallax({
    xparallax: '75px',
    yparallax: '75px'
  });
  $('.animate-container_i12 .animate').parallax({
    xparallax: false,
    yparallax: '75px'
  });
  $('.animate-container_i13 .animate').parallax({
    xparallax: false,
    yparallax: '75px'
  });
  ...
  $('.service-btn').click(function () {
    var link = $(this).data('price');
    var hiddenInput = $('https://t.me/Vanills_Studio form').find('input[name=price]');
